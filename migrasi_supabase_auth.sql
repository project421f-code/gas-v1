...
DO $$ DECLARE pol RECORD; BEGIN
  FOR pol IN SELECT policyname, tablename FROM pg_policies WHERE schemaname = 'public' AND (policyname LIKE 'Auth users%' OR policyname LIKE 'Users can%' OR policyname = 'Public read access' OR policyname LIKE 'Allow public%') LOOP
